...
export default function Hero() {
  return (
    <div className='flex flex-wrap h-[276] flex-col font-sans justify-center items-center gap-[25px] mx-[21px] xl:flex-wrap xl:gap-[24px] xl:self-center xl:max-w-[50%] xl:m-[0px] xl:h-[370px]'>
        <h2 className='flex text-center flex-wrap items-center font-sans flex-col text-4xl xl:text-left xl:self-start xl:w-[360px]'>Your favourite manga reader 😏</h2>
