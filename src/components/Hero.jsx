...
export default function Hero() {
  return (
    <div className='flex flex-wrap h-[276] flex-col font-sans justify-center items-center gap-[25px] mx-[21px] xl:flex-wrap xl:gap-[24px] xl:self-center xl:w-[50] xl:m-[0px] xl:h-[326px]'>
