...
function App() {
  ...
  return (
    <div className='m-0 w-auto h-auto bg-black opacity-95 md:w-100 md:h-100'>
    ...
    <main className='flex justify-center w-auto min-h-screen text-white bg-[url("../public/fondo2.png")] md:bg-[url(hidden)] bg-contain bg-center bg-no-repeat md:flex-col items-start gap-[24px] md:w-[100%] md:h-[100%]'>
      ...
      <div className='flex flex-row self-center justify-around w-[100%] md:flex-wrap'>
        ...
        <div className='flex h-[276] flex-col font-sans justify-center items-center gap-[25px] mx-[21px] md:flex-wrap md:gap-[24px] md:self-center md:w-[442px] md:m-[0px] md:h-[326px]'>
          ...
          <button className='flex py-[10px] items-center gap-[60px] self-stretch rounded-md border-[#42869d] border-2 bg-white opacity-40 backdrop-blur-md shadow-white'>
            <img className='' src="search.png" alt="s" />
            <p className='text-center text-black opacity-100 text-xl'>Search mangas</p>
          </button>
        </div>
      </div> 
    </main>
    <footer className='flex flex-wrap flex-col items-center bg-black h-[400px] md:h-[750px] md:flex-row md:justify-around md:text-[1.5rem]'>
    <img className='w-[98%] h-[100px] flex-wrap rounded-[70px] md:h-[350px] object-cover' src="footerimg.png" alt="" />
    <div className='flex flex-wrap flex-col md:flex-row justify-evenly h-[75%] md:h-auto md:w-[100%]'>
      <div className='flex flex-col items-center md:flex-row md:inline-flex md:self-start md:gap-[62px] h-[auto] p-0 text-white'>
        <a href="#">Home</a>
        <a href="#">Mangas</a>
      </div>
      <img className='w-[2.5rem] self-center' src="logo.png" alt="" />
